...
import { createWorkspace, updateWorkspace, deleteWorkspace, inviteUserToWorkspace, getWorkspaceUsers, acceptInvite, assignRolePermission, removeUserFromWorkspace, getAdminWorkspaces, toggleWorkspaceStatus, revokeInvitation, getRolePermissions, removeRolePermission, getWorkspacesByUserId, exportWorkspaceData, searchWorkspaces } from '../controllers/workspace.controller';
...
router.post('/', authMiddleware, upload.array('images'), createWorkspace);
